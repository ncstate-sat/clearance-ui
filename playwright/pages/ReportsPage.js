export class ReportsPage {
    ...
    constructor(page) {
        ...
        this.downloadLiaisonAssignmentsButton = this.page.getByTestId('liaison-assignments-download-btn')
        ...
        this.mockedClearanceEntry = this.page.getByText('VRB-SAT All Doors MOD1-DEPT')
    ...
    async unroutePeopleClearancesRequest() {
        await this.page.unroute(/\/reports\/clearances\/persons\?clearances_limit=\d+&clearances_skip=\d+/)
    }

    async unrouteDoorClearancesRequest() {
        await this.page.unroute(/\/reports\/clearances\/doors\?clearances_limit=\d+&clearances_skip=\d+/)
    }
